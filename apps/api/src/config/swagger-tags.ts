/**
 * Canonical Swagger / OpenAPI tag names (Phase 0–18).
...
export const SWAGGER_TAG_DEFINITIONS: ReadonlyArray<{
  ...
  {
    name: SWAGGER_TAG.Projets,
    description:
      'Technical projects, technicians, installations, tasks, reports and commissioning',
  },
  {
    name: SWAGGER_TAG.Maintenance,
    description:
      'Service requests, support tickets, maintenance contracts, interventions and warranties',
  },
  {
    name: SWAGGER_TAG.Finances,
    description:
      'Invoices, payments, expenses, refunds and accounts receivable/payable',
  },
  {
    name: SWAGGER_TAG.Collaboration,
    description:
      'Tasks, appointments, polymorphic comments, in-app notifications and activities alias',
  },
];
